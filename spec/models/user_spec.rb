  ...
  describe 'ユーザー新規登録' do
    ...
    context 'ユーザー登録できない場合' do
      ...
      it 'passwordが全角文字を含んでは登録できない' do
        @user.password = 'あいうa12'
        @user.password_confirmation = 'あいうa12'
        @user.valid?
        expect(@user.errors.full_messages).to include('Password is invalid')
      end
